...
def run(train_gate, inference_gate, n_training_iterations=1, n_episodes_for_inferencing = 1, save=True, plot=True, noise_file=noise_file, plot_target_change = True):
    ...
    alg_config.exploration_config["scale_timesteps"] = int((n_training_iterations * 1000) / (total_Haar_nums * 2))
    ...
    config_table(env_config, alg_config, save_filepath, plot_target_change)
