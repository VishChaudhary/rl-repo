...
def run_ray_tune(n_configurations=100, save=True):
    ...
    search_space = {
        ...
        "actor_num_hiddens": tune.choice([3,10, 20, 50, 75, 1e2]),
        "actor_layer_size": tune.choice([30, 50, 100, 150, 200, 250,300]),
        "critic_num_hiddens": tune.choice([3,10, 20, 50, 75, 1e2]),
        "critic_layer_size": tune.choice([30, 50, 100, 150, 200, 250,300])
    }
    algo = OptunaSearch()
    tuner = tune.Tuner(
        objective,
